Pod::Spec.new do |s|
  ...
  s.description  = <<-DESC
                   [Forked] Reusable component for displaying the WordPress.com post editor in an iOS application
                   DESC
  ...
  s.source       = { :git => "https://github.com/yuyedaidao/WordPress-Editor-iOS.git", :tag => s.version.to_s }
